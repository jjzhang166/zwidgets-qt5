...
class ZWIDGETSSHARED_EXPORT ExtendWidget: public QObject, public ZObject
{
    Q_OBJECT
...
private:
    ...
    Z_DECLARE_PRIVATE(ExtendWidget)
};
...
class ZWIDGETSSHARED_EXPORT AnchorsBase : public QObject
{
    Q_OBJECT
